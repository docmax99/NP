...
export default function Boxing() {
    return( 
        ...
        <div class="flex gap-4">
            <div class="bg-red-400 w-1/3 h-64 mr-2 ml-4 rounded-3xl"><Image src="/Images/Hobbit.png" width={140} height={140} alt="Dreamhouse" className="w-full h-full object-cover  rounded-3xl "/></div>
            <div class="bg-yellow-300 w-1/3 h-64 mr-2 ml-4 rounded-3xl"><Image src="/Images/Berghaus.png" width={140} height={140} alt="BergHaus" className="w-full h-full object-cover   rounded-3xl  "/></div>
            <div class="bg-green-400 w-1/3 h-64 mr-4 ml-2 rounded-3xl"><Image src="/Images/Modernhouse.png" width={140} height={140} alt="Modernhouse" className="w-full h-full object-cover  rounded-3xl "/></div>
        </div>
